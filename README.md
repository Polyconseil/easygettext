...
Also, it's able to parse Jade/Pug languages, Javascript ES7 code, event within Vue component files,
even if those themselves contain Pug templates and ES7 code.
